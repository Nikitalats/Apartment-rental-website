...
<form method="POST" enctype="multipart/form-data">
		...
		?>
			...
			<button class="margin-top-40 button" name="submit" style="margin-bottom:55px">Отправить</button>
		</div>
...
if (isset($_POST['submit'])) {
	...
	$post_image_tmp=$_FILES['document']['tmp_name'];
	move_uploaded_file($post_image_tmp, "uploads/$document");
	$canccel="Update room set document='$document' WHERE id_room='$id_room'";			
	$stat=mysqli_query($con,$canccel); 			
}
