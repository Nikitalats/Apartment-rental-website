...
$day= 86400;
$d1_ts = strtotime($datearrive);
$d2_ts = strtotime($dateleave);
...
$day = date('d');
?>
	<form action="word1.php" method="POST" enctype="multipart/form-data">
			<div class="row with-forms">
					<div class="col-md-6">
					<h5>ФИО</h5>
				
						<input id="fullname" type="text" data-unit="" class="input-ru" name="fio1" required>
		...
		<input type="hidden" name="id_user" value="<?=$id ?>">
				<div class="col-md-6">
					...
					<div class="select-input disabled-first-option">
						<input id="adres" type="text"  class="input-reg"  data-unit="" name="adres1" required>
					</div>
				</div>
					<div class="col-md-6">
					<h5>Серия</h5>
					<div class="select-input disabled-first-option">
						<input class="input-number" maxlength="4"  type="text"  data-unit="" name="seria1" required>
					</div>
				</div>
					<div class="col-md-6">
					<h5>Номер</h5>
		
						<input type="text"  class="input-number1" maxlength="6"  data-unit="" name="nomer1" required>
			
				</div>
					<div class="col-md-6">
					<h5>Кем выдан</h5>
			
					<input  id="vidan" data-unit="" class="input-ru" name="vidan1" required>
				
				</div>
				<div class="col-md-6">
					<h5>Дата рождения</h5>
				
						<input id="datepicker1"  data-unit="" name="birth1" required>
				</div>

					<input type="hidden"  data-unit="" name="telephone" value="<?=$tele?>" required>
	
			
					<div class="col-md-6">
					<h5>Улица</h5>
					<div class="select-input disabled-first-option">
					<input type="text" class="input-ru" data-unit="" name="ylica" required>
					</div>
				</div>
					<div class="col-md-6">
					<h5>Дом</h5>
			
					<input type="text"  data-unit="" name="dom" required>
		
				</div>
					<div class="col-md-6">
					<h5>Квартира</h5>
					<div class="select-input disabled-first-option">
					<input type="text"  data-unit="" name="kvartira" required>
					</div>
				</div>
					...
					<input type="text"  data-unit="₽" name="summa" value="<?=$summa?>" required>
...
<script>
    var TOKEN = "3368d48c655ba6b3a33fda49b564f5647f6be8fe";




    $("#vidan").suggestions({
        token: "3368d48c655ba6b3a33fda49b564f5647f6be8fe",
   type: "fms_unit",
