	...
	<form action="word.php" method="POST" enctype="multipart/form-data">
			<div class="row with-forms">
					...
					<h5>ФИО</h5>
						...
						<input id="fullname" type="text" class="input-ru" data-unit="" name="fio" >
	...
	<input type="hidden" name="id_reserve" value="<?=$id_reserve ?>">
		<input type="hidden" name="id_city" value="<?=$name_city ?>">
				...
				<div class="col-md-6">
					<h5>Адрес регистрации</h5>
						...
						<input id="adres" type="text"  class="input-reg" data-unit="" name="adres" required>
				  <p id="message"></p>
				</div>
		...
		<h5>Серия и номер паспорта </h5>
					<div class="col-md-6">
						...
						<input class="input-number" maxlength="4" type="text"  data-unit="" name="seria" required>

				</div>
					<div class="col-md-6">
				
				
						<input class="input-number1" maxlength="6" type="text"  data-unit="" name="nomer" required>
				</div>
				</div>
					<div class="col-md-6">
					<h5>Кем выдан</h5>
				
						<input id="vidan" type="text"   data-unit="" name="vidan" placeholder="Код или название" required>
			
				</div>
				<div class="col-md-6">
					<h5>Дата рождения</h5>
	
					<input id="datepicker"   name="birth" required>
				
				</div>
				<div class="col-md-6">
					<h5>Телефон</h5>
				
					<input id="phone" type="text"  data-unit="" name="telephone" required>
...
} else if (!address.flat) {
    showMessage("Укажите квартиру");
  } 
  else {
